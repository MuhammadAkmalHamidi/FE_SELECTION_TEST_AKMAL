...
export const Navbar = () => {
    const user = useSelector((state) => state.user.value.roleId)
    ...
    return (
        <Box boxShadow={"0px 0px 15px black"} position={"fixed"} w={{ base: "100px", sm: "120px", md: "150px", lg:"140px" }} h={"100vh"} bgGradient={"linear(to-b, #008b8b, #00cccc)"}>
            ...
            <Box color={"white"} mt={"30px"}>
                {user === 1 ?
                    (
                        <Box>
                            <Flex _hover={{ bgColor: "#008b8b" }} transition={"0.3s"} cursor={"pointer"} p={"10px"} color={"white"} alignItems={"center"} gap={"5"} mb={"100px"}>
                                ...
                                <Flex onClick={listKaryawan}>List Karyawan</Flex>
                            </Flex>
                            <Flex _hover={{ bgColor: "#008b8b" }} transition={"0.3s"} cursor={"pointer"} p={"10px"} color={"white"} alignItems={"center"} gap={"5"} mb={"100px"}>
                                <AiOutlineClockCircle size={"50px"} color="white" />
                                <Flex onClick={jadwalAdmin}>Jadwal Kerja</Flex>
                            </Flex>
                            <Flex _hover={{ bgColor: "#008b8b" }} transition={"0.3s"} cursor={"pointer"} p={"10px"} color={"white"} alignItems={"center"} gap={"5"} mb={"100px"}>
                    ...
                    (
                        <Flex justifyContent={"center"}>
                            <Box>
                                <Box onClick={home} _hover={{ bgColor: "#008b8b" }} transition={"0.3s"} cursor={"pointer"} p={"10px"} color={"white"} alignItems={"center"} gap={"5"} mb={"15px"}>
                                    <Flex justifyContent={"center"}>
                                        <AiOutlineHome size={"50px"}  color="white" />
                                    </Flex>
                                    <Flex justifyContent={"center"} fontSize={{ base: "15px", sm: '20px', md: "20px" }}>Home</Flex>
                                </Box>
                                <Box onClick={jadwal} _hover={{ bgColor: "#008b8b" }} transition={"0.3s"} cursor={"pointer"} p={"10px"} color={"white"} alignItems={"center"} gap={"5"} mb={"15px"}>
                                    <Flex justifyContent={"center"}>
                                        <FaRegCalendarDays size={"50px"}  color="white" />
                                    </Flex>
                                    <Flex justifyContent={"center"} fontSize={{ base: "15px", sm: '20px', md: "20px" }}>Jadwal Shift</Flex>
                                </Box>
                                <Box onClick={gajiBulanan} _hover={{ bgColor: "#008b8b" }} transition={"0.3s"} cursor={"pointer"} p={"10px"} color={"white"} alignItems={"center"} gap={"5"} mb={"15px"}>
                                    <Flex justifyContent={"center"}>
                ...
                </Flex>) : (<Flex justifyContent={"center"} mt={"50px"} >
                    <Button onClick={logOut} fontSize={"20px"} cursor={"pointer"} justifyContent={"center"} bgColor={"white"} boxShadow={"0px 0px 7px white"} color={"#009698"} fontWeight={"bold"} align={"center"} borderRadius={"15px"}>
                        Keluar
                    </Button>
                </Flex>)}

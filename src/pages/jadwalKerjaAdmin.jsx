...
export const JadwalKerjaAdmin = () => {
    ...
    const jadwal = async () => {
        try {
            const response = await axios.get(`https://be-selection-test-akmal.vercel.app//jadwal`)
    ...
    const deleteShift = async () => {
        try {
            const response = await axios.delete(`https://be-selection-test-akmal.vercel.app//jadwal/delete/${userId}`)
            setReload(!reload)
            onClose()
        } catch (error) {
            console.log(error);
